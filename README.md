...
## File list (v1 MVP, exactly 13 files)
...
6. `src/scoring.ts` - zod validation + scoring math + comparison orchestration
7. `src/mcp.ts` - MCP server factory with 4 tools
8. `public/index.html` - frontend form + result display
9. `public/styles.css` - frontend styles
10. `public/app.js` - frontend logic
11. `public/agents-guide.md` - MCP integration guide
12. `README.md` - this file
13. `test-plan.md` - local validation checklist (no automated tests in v1)
